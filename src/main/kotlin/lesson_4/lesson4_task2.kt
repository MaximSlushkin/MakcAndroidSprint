...
fun main() {
    ...
    val isCargo1Average = cargo1Weight > minWeight && cargo1Weight <= maxWeight && cargo1Volume < maxVolume
    val isCargo2Average = cargo2Weight > minWeight && cargo2Weight <= maxWeight && cargo2Volume < maxVolume
