...
fun main() {
    ...
    val canSail = (
            (!hasDamage && crewCount in MIN_CREW_COUNT..MAX_CREW_COUNT && foodBoxes > MIN_FOOD_BOXES && favorableWeather) ||
                    (hasDamage && crewCount == RECOMMENDED_CREW_COMPOSITION_DAMAGE && favorableWeather && foodBoxes >= MIN_FOOD_BOXES))
